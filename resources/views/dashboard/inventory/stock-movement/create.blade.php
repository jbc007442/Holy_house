        ...
        <div class="flex items-center justify-between">
            ...
            <div>
                ...
                <p class="text-sm text-zinc-500 mt-1">
                    Record inventory stock out and adjustments.
                </p>
            </div>
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="quantity" type="number" name="quantity" min="1" value="{{ old('quantity') }}"
                            placeholder="Enter Quantity" class="w-full rounded-xl border border-zinc-300 px-4 py-3">
                    ...
                    <div>
                        ...
                        <label class="flex items-center gap-3 rounded-xl border border-zinc-300 px-4 py-3 cursor-pointer">
                            ...
                            <input type="checkbox" id="kitchen" name="kitchen" value="1"
                                {{ old('kitchen') ? 'checked' : '' }} class="rounded border-zinc-300">
                    ...
                    <div>
                        ...
                        <input type="text" id="other_property" name="other_property" value="{{ old('other_property') }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea rows="4" name="remarks" placeholder="Enter remarks..."
                            class="w-full rounded-xl border border-zinc-300 px-4 py-3">{{ old('remarks') }}</textarea>
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/inventory/stock-movement/create-stock-movement.js') }}"></script>
@endpush
