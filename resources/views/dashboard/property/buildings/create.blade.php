                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('floors') }}"
                            placeholder="5"
                            class="w-full h-11 rounded-xl border @error('floors') border-red-500 @else border-zinc-300 @enderror px-4 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400">
