            ...
            <form action="{{ route('dashboard.property.rooms.store') }}" method="POST">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="room_number" value="{{ old('room_number') }}" placeholder="101"
                            class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:ring-2 focus:ring-amber-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="capacity" value="{{ old('capacity') }}" placeholder="2" min="1"
                            class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:ring-2 focus:ring-amber-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="base_price" value="{{ old('base_price') }}" placeholder="1500"
                            step="0.01" min="0"
                            class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:ring-2 focus:ring-amber-500">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="4" placeholder="Room description..."
